                              ...
                              children: <Widget>[
                                ...
                                Expanded(
                                  child: Container(
                                    ...
                                    child: Text(user["Class"].toString(), style:TextStyle(fontSize: 18)),
                                  )
                                )
                              ],
                            ),
                              ...
                              children: <Widget>[
                                ...
                                Expanded(
                                  child: Container(
                                    ...
                                    child: Text(user["City"].toString(), style:TextStyle(fontSize: 18)),
                                  )
                                )
                              ],
                            ),
                              ...
                              children: <Widget>[
                                ...
                                Expanded(
                                  child: Container(
                                    ...
                                    child: Text(user["Country"].toString(), style:TextStyle(fontSize: 18)),
                                  )
                                )
                              ],
                            ),
